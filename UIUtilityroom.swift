...
class UIUtilityroom: UIRoom {
    ...
    override func drawLayers(rect: CGRect) {
        ...
        layers.append(UIDrawHelper.instance.utility.drawUtility(type: .watertank, rect: drawrect, fillcolor: fillcolor, strokecolor: bordercolor, borderwidth: borderwidth))
    }
